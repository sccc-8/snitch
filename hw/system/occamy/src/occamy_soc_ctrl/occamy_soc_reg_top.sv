...
module occamy_soc_reg_top #(
  ...
  logic [4:0] isolate_qs;
  logic [4:0] isolate_wd;
  logic isolate_we;
  logic [4:0] isolated_qs;
  logic isolated_re;
  ...
  assign isolate_we = addr_hit[41] & reg_we & !reg_error;
  assign isolate_wd = reg_wdata[4:0];

  assign isolated_re = addr_hit[42] & reg_re & !reg_error;

  assign ro_cache_enable_we = addr_hit[43] & reg_we & !reg_error;
  assign ro_cache_enable_wd = reg_wdata[0];

  assign ro_cache_flush_we = addr_hit[44] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[41]: begin
        reg_rdata_next[4:0] = isolate_qs;
      end

      addr_hit[42]: begin
        reg_rdata_next[4:0] = isolated_qs;
      end
